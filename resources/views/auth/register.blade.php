                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefone" type="integer" class="form-control @error('telefone') is-invalid @enderror" name="telefone" value="{{ old('telefone') }}" required autocomplete="telefone" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="data_nascimento" type="date" class="form-control @error('data_nascimento') is-invalid @enderror" name="data_nascimento" value="{{ old('data_nascimento') }}" required autocomplete="name" autofocus>
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio3">Outro</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="foto_perfil" type="text" class="form-control @error('name') is-invalid @enderror" name="foto_perfil" value="{{ old('foto_perfil') }}" required autocomplete="name" autofocus>
