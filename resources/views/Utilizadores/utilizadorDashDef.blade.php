...
<div class="container">
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      ...
      <form method="POST" action="{{ url('/dashboard/definicoes/update/'.Auth::user()->id ) }}">
                        @csrf
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio2">Profissional</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="foto_perfil" type="text" class="form-control @error('name') is-invalid @enderror" name="foto_perfil" value="{{ Auth::user()->fotoperfil  }}" required autocomplete="name" autofocus>
